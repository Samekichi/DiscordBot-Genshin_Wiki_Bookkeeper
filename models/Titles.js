        ...
        class Titles extends Model {
            ...
            static async createTitle(
                ...
                if (!name || !createdBy || !guildId) {
                    console.error("Error creating title: name, createdBy, and guildId must be specified to create a Title:");
                    console.log(JSON.stringify(arguments[0], null, 2))
                    throw new Error(
                        "name, createdBy, and guildId must be specified to create a Title."
                    );
                }
